...
<div class="w-full h-full">
    <div class="bg-white w-full h-full overflow-auto">
        <div class="flex gap-4 items-center mb-6">
            <a class="text-lg" href="/dashboard">
                <i class="fa-solid fa-chevron-left"></i>
            </a>
            <h1 class="font-bold text-2xl">Tambah Laporan</h1>
        </div>
        <form id="laporan-form" action="{{ route('laporan.store') }}" method="POST" enctype="multipart/form-data" class="w-full">
            @csrf
            <div class="mb-5">
                <label for="foto" class="block mb-2 text-sm font-medium text-gray-900">Foto</label>
                <div class="flex flex-col items-center">
                    <video id="video" autoplay class="mb-2 w-full"></video>
            ...
            <div class="mb-5">
                ...
                <textarea id="keterangan" name="keterangan" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5" required>{{ old('keterangan') }}</textarea>
            </div>
            <div class="mb-5">
            ...
            <div class="mb-5">
                <button type="submit" id="submit-button" class="text-white bg-blue-700 hover:bg-blue-800 focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium rounded-lg text-sm px-5 py-2.5 text-center disabled:opacity-60" disabled>Tambah Laporan</button>
            </div>
        </form>
    </div>
</div>
...
<script>
    ...
    // Cek input file ketika halaman dimuat
    document.getElementById('foto').addEventListener('change', checkSubmitButton);
</script>
